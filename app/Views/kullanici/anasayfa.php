                    ...
                    <div class="d-flex align-items-center justify-content-between p-3 bg-light rounded">
                        <div>
                            <h4 class="mb-1 fw-bold text-dark page-title">
                                <i class="ki-outline ki-home fs-3 me-2 text-primary"></i>
                                Hoş Geldiniz!
                            </h4>
            ...
            <div class="row g-4">
                    ...
                    <div class="card border h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="d-grid gap-2">
                                <a href="/isemri/listesi" class="btn btn-light text-start p-3 border shadow-sm hover-elevate-up">
                                ...
                                <a href="/isemri/olustur" class="btn btn-light text-start p-3 border shadow-sm hover-elevate-up">
                ...
                <div class="col-lg-6 col-12">
                    <div class="card border h-100">
                        ...
                        <div class="card-body p-3">
                            <div class="d-grid gap-2">
                                <a href="/ciro/listele" class="btn btn-light text-start p-3 border-2 shadow-sm hover-elevate-up">
                                ...
                                <a href="/gider/listesi" class="btn btn-light text-start p-3 border-2 shadow-sm hover-elevate-up">
...
class DashboardManager {
    ...
    updateLastRefreshTime() {
        ...
        if (!refreshIndicator) {
            ...
            document.querySelector('.page-title')?.appendChild(refreshIndicator);
        }
    ...
    setupEventListeners() {
        ...
        refreshBtn.onclick = () => this.loadDashboardStats();
